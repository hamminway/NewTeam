...
public class SearchRepositoryImpl implements SearchRepository {
    ...
    private BooleanExpression searchByLocationLike(String location, StringPath element){
        return StringUtils.isEmpty(location)? null :
                element.like("%" +location + "%");
        ...
        if(searchQuery.equals("")){
            ...
            if(StringUtils.equals("", searchBy)){
                return individualMem.pageName.like("%" + searchQuery + "%")
                        .or(individualMem.characterName.like("%" + searchQuery + "%"))
                        .or(individualPost.postTitle.like("%" + searchQuery + "%"));
            } else if(StringUtils.equals("storeName", searchBy)) {
    ...
    public Page<SearchPreviewDTO> getSearchPrevPage(SearchDTO searchDTO, Pageable pageable) {
        ...
        content.addAll(queryFactory
                ...
                .where(regDtsAfter(searchDTO.getSearchDateType()),
                        ...
                        ,searchByLocationLike(searchDTO.getLocation(), partnerMemPK.store_location))
